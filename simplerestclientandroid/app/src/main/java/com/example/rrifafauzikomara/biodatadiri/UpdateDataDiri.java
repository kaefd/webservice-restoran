...
public class UpdateDataDiri extends AppCompatActivity {
    ...
    private void getPesanan(){
        class GetPesanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Kesan/get_kesan.php?id=",id);
                return s;
            }
        }
    ...
    private void updatePesanan(){
        ...
        class UpdatePesanan extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("hhttps://kaefdeap.000webhostapp.com/server/Kesan/update_kesan.php", hashMap);
    ...
    private void deletePesanan(){
        class DeletePesanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Kesan/delete_kesan.php?id=", id);
                return s;
            }
        }
