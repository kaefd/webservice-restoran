...
public class UpdateUser extends AppCompatActivity {
    ...
    private void getUser(){
        class GetUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/User/get_user.php?id=",id);
                return s;
            }
        }
    ...
    private void updateUser(){
        ...
        class UpdateUsers extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://kaefdeap.000webhostapp.com/server/User/update_user.php", hashMap);
    ...
    private void deleteUser(){
        class DeleteUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/User/delete_user.php?id=", id);
                return s;
            }
        }
