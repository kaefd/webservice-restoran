...
public class UpdateMakanan extends AppCompatActivity {
    ...
    private void getMakanan(){
        class GetMakanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Makanan/get_makanan.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMakanan(){
        ...
        class UpdateMakanan1 extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://kaefdeap.000webhostapp.com/server/Makanan/update_makanan.php", hashMap);
    ...
    private void deleteMakanan(){
        class DeleteMakanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Makanan/delete_makanan.php?no=", id);
                return s;
            }
        }
