...
public class UpdateMinuman extends AppCompatActivity {
    ...
    private void getMinuman(){
        class GetMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Minuman/get_minuman.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMinuman(){
        ...
        class UpMinuman extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://kaefdeap.000webhostapp.com/server/Minuman/update_minuman.php", hashMap);
    ...
    private void deleteMinuman(){
        class DeleteMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://kaefdeap.000webhostapp.com/server/Minuman/delete_minuman.php?no=", id);
                return s;
            }
        }
